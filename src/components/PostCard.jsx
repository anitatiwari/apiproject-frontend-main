...
export default function PostCard({
  ...
  return (
    ...
    <div
      ...
      data-v0-t="card"
    >
      <EditPostModal postId={postId} isOpen={editModalOpen} setIsOpen={setEditModalOpen} existingTitle={title} existingDescription={content} />
      <div className="flex space-x-4">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center">
            ...
            <p className="text-gray-500 "><ReactTimeAgo date={createdAt} timeStyle="twitter" /></p>
          </div>
          <p className="mt-2 p-2 text-gray-800">
            {content}
          </p>
          ...
          <div className=' flex mt-2'>
            ...
            class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded inline-flex items-center">
              <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a.914.914 0 01-.494-.149l-7-4a1 1 0 010-1.702l7-4a1 1 0 011 1.702L4.236 10 11 13.447l1.74-1.002a1 1 0 011 1.702l-7 4A.914.914 0 0110 18zm8-10a1 1 0 10-2 0 1 1 0 002 0zM2 8a1 1 0 112-2h11a1 1 0 110 2H4a1 1 0 01-2 0z" clip-rule="evenodd" />
              </svg>
              Like ({numberOfLikes})
            </button>
